...
//                    if (HandleRequest_HEAD(request, response, _fileContentBuffer)) { continue; }

//                    if (await HandleRequest_Range(request, response, _fileContentBuffer)) { continue; }

//                    HandleRequest_FullGET(request, response, _fileContentBuffer);
//                }
//                catch (Exception ex)
//                {
...
//        private async Task<bool> HandleRequest_Range(HttpListenerRequest request, HttpListenerResponse response, byte[] buffer)
//        {
...
//                    // ÐÞÕý·Ç·¨ Range
//                    if (from > to || from < 0 || from >= buffer.Length)
//                    {
...
//                    try
//                    {
//                        await SafeWriteAsync(response.OutputStream, buffer, from, length);
//                    }
//                    catch (IOException ex)
//                    {
//                        Debug.WriteLine("WriteAsync IOException: " + ex);
//                        return true;
//                    }
//                    catch (Exception ex)
//                    {
//                        Debug.WriteLine("WriteAsync exception: " + ex);
//                        return true;
//                    }

...
namespace MultithreadDownload.Protocols
{
    ...
    {
        DownloadWorkDelegate DownloadWorkDelegate { get; }
        ...
        Result<int> DownloadFile(Stream inputStream, Stream outputStream, DownloadThread downloadThread);
        ...
        Result<bool> PostDownloadProcessing(Stream outputStream, DownloadThread downloadThread);
    }
}